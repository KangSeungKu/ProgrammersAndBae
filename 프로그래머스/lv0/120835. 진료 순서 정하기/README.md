...
<p>[solution1] 메모리: 33.4 MB, 시간: 0.07 ms</p>
<p>[solution2] 메모리: 33.4 MB, 시간: 0.06 ms</p>
...
<p>별도의 Map을 사용하였을 때와 일반배열의 indexOf를 사용하였을 때의 차이</p>
<p> -> Map을 구성하면서 시간이 더 소요된 것으로 보여짐.</p>
