...
<p>[solution1] 메모리: 37.4 MB, 시간: 1.47 ms</p>
<p>[solution2] 메모리: 39.2 MB, 시간: 163.30 ms</p>
...
<p><code>Array.prototype.shift</code>함수를 사용하여 개선하려고 했지만, 효율은 더욱 좋아지지 않기만 한 결과를 얻게됨.</p>
