...
<p>[solution1] 메모리: 33.9 MB, 시간: 0.47 ms</p>
<p>[solution2] 메모리: 33.4 MB, 시간: 0.45 ms</p>
...
<p><code>Date</code>객체를 이용하는 것보다 단순 숫자계산만으로 처리할 경우 미비하지만 좀 더 좋은 효율을 낼 수 있는 것을 확인함.</p>
<p>메모리적 효율과 가독성을 생각한다면 그렇게 좋은 방법으로 보여지지는 않음.</p>
